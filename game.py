...
# def main():
    ...
    def show_gamestart_screen():
        ...
        boom=pygame.image.load('images/fruit_images/boom.png')
        sandia=pygame.image.load('images/fruit_images/sandia.png')
        peach=pygame.image.load('images/fruit_images/peach.png')
        gameDisplay.blit(background, (0, 0))
        gameDisplay.blit(logo1, (10, 10))
        gameDisplay.blit(logo2, (320, 50))
        gameDisplay.blit(boom, (480, 190))
        gameDisplay.blit(sandia, (290, 255))
        gameDisplay.blit(peach, (100, 260))
        ...
        while waiting:
            ...
            if 100 < current_position[0] < 150 and 260 < current_position[1] < 300:
                no_boom[0]=False
                waiting = False
            if 290 < current_position[0] < 350 and 255 < current_position[1] < 310:
                no_boom[0]=True
                waiting = False
            if 480 < current_position[0] < 540 and 190 < current_position[1] < 250:
                pygame.quit()
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    pygame.quit()
        ...
        if game_over:
            if first_round:
                ...
                if no_boom[0]==True:
                    ...
                    data={}
                    fruits = {'apple', 'banana', 'basaha', 'peach', 'sandia', 'boom', 'boom1', 'boom2', 'boom3'}
                    for fruit in fruits:
                        generate_random_fruits(fruit)
                first_round = False
        ...
        for key, value in data.items():
            if value['throw']:
                ...
                if not value['hit'] and value['x'] < current_position[0] < value['x'] + 60 \
                    ...
                    if key == 'boom' or key == 'boom1' or key == 'boom2' or key == 'boom3':
                        player_lives -= 1
                        if player_lives == 0:
